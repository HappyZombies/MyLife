...
class App extends Component {
  constructor() {
    ...
    currentEvent.addSmallEvent({
      message: `You were born a ${player.gender}, in ${player.country}`
    });
    ...
    return [
      {
        ...
        render: () => (
          <Tab.Pane className="eventsView" attached={false}>
            <EventsView
      ...
      },
      {
        ...
        render: () => (
          <Tab.Pane attached={false}>
            <StatsView player={this.state.player} />
          </Tab.Pane>
        )
      },
      {
